...
suite('Network Search Tests (Mobile): user with active Medicare plan', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.mckayshir;
    ...
    test(networkSearchRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.networkSearchAnswer(userData, 'mobile', 'active', environmentVariables.domain);
