...
let userData;
let userId; 
const casualConversationsRandomQuestion = randomizer.getRandomQuestion(questions.conditionOrMoodOfBotQuestionsArray);

suite('Casual conversation: Questions about condition or mood of bot', function () {
    ...
    test(casualConversationsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.casualConversationsAnswer('questions about condition or mood of bot');
