...
suite('Casual conversation: Question with different response expectation intents recognition', function () {
    ...
    questions.differentResponseExpectationQuestionsArray.forEach((question) => {
