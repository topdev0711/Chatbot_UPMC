...
let userData;
let userId; 
const casualConversationsRandomQuestion = randomizer.getRandomQuestion(questions.botNotBeingAPersonQuestionsArray);

suite('Casual conversation: Questions about bot not being a person', function () {
    ...
    test(casualConversationsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.casualConversationsAnswer('questions about bot not being a person');
