...
suite('Casual conversation: Questions about condition or mood of bot intents recognition', function () {
    ...
    questions.conditionOrMoodOfBotQuestionsArray.forEach((question) => {
