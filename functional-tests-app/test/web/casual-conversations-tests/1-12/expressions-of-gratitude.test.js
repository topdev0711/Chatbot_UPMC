...
let userData;
let userId; 
const casualConversationsRandomQuestion = randomizer.getRandomQuestion(questions.expressionsOfGratitudeQuestionsArray);

suite('Casual conversation: Expressions of gratitude', function () {
    ...
    test(casualConversationsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.casualConversationsAnswer('expressions of gratitude');
