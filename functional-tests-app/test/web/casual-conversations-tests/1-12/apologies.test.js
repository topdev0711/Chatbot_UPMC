...
let userData;
let userId; 
const casualConversationsRandomQuestion = randomizer.getRandomQuestion(questions.apologiesQuestionsArray);

suite('Casual conversation: Apologies', function () {
    ...
    test(casualConversationsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.casualConversationsAnswer('apologies');
