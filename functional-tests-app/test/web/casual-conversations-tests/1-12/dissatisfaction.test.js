...
let userData;
let userId; 
const casualConversationsRandomQuestion = randomizer.getRandomQuestion(questions.dissatisfactionWithBotQuestionsArray);

suite('Casual conversation: Dissatisfaction with bot response', function () {
    ...
    test(casualConversationsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.casualConversationsAnswer('dissatisfaction');
