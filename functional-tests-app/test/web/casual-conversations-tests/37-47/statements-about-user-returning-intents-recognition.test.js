...
suite('Casual conversation: Statements about user returning intents recognition', function () {
    ...
    questions.statementsAboutUserReturningQuestionsArray.forEach((question) => {
