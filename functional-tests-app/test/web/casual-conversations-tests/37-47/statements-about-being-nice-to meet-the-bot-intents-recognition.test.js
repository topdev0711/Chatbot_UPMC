...
suite('Casual conversation: Statements about being nice to meet the bot intents recognition', function () {
    ...
    questions.statementsAboutBeingNiceToMeetTheBotQuestionsArray.forEach((question) => {
