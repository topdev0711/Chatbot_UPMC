...
let userData;
let userId; 
const casualConversationsRandomQuestion = randomizer.getRandomQuestion(questions.statementsAboutBeingNiceToMeetTheBotQuestionsArray);

suite('Casual conversation: Statements about being nice to meet the bot', function () {
    ...
    test(casualConversationsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.casualConversationsAnswer('statements about being nice to meet the bot');
