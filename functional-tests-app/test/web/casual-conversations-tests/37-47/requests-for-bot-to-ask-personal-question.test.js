...
let userData;
let userId; 
const casualConversationsRandomQuestion = randomizer.getRandomQuestion(questions.requestsForBotToAskPersonalQuestionQuestionsArray);

suite('Casual conversation: Requests for bot to ask personal question', function () {
    ...
    test(casualConversationsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.casualConversationsAnswer('requests for bot to ask personal question');
