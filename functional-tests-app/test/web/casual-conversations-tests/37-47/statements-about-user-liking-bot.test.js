...
let userData;
let userId; 
const casualConversationsRandomQuestion = randomizer.getRandomQuestion(questions.statementsAboutUserLikingBotQuestionsArray);

suite('Casual conversation: Statements about user liking bot', function () {
    ...
    test(casualConversationsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.casualConversationsAnswer('statements about user liking bot');
