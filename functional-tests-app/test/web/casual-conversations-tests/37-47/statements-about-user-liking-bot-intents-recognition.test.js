...
suite('Casual conversation: Statements about user liking bot intents recognition', function () {
    ...
    questions.statementsAboutUserLikingBotQuestionsArray.forEach((question) => {
