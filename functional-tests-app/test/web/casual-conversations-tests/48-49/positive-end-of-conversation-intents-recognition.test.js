...
suite.only('Casual conversation: Positive end of conversation intents recognition', function () {
    ...
    questions.positiveEndOfConversationQuestionsArray.forEach((question) => {
