...
suite('Casual conversation: Leaving or ending conversation intents recognition', function () {
    ...
    questions.leavingOrEndingConversationQuestionsArray.forEach((question) => {
