...
let userData;
let userId; 
const casualConversationsRandomQuestion = randomizer.getRandomQuestion(questions.insultsToBotsAppearanceQuestionsArray);

suite('Casual conversation: Insults to bot appearance', function () {
    ...
    test(casualConversationsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.casualConversationsAnswer('insults to bots appearance');
