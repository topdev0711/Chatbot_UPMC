...
let userData;
let userId; 
const casualConversationsRandomQuestion = randomizer.getRandomQuestion(questions.leavingOrEndingConversationQuestionsArray);

suite('Casual conversation: Leaving or ending conversation', function () {
    ...
    test(casualConversationsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.casualConversationsAnswer('leaving or ending conversation');
