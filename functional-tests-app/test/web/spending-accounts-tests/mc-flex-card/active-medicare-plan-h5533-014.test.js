...
suite('Spending Account (MC Flex Card) Tests: Active Medicare Plan with PBP H5533-014 (Annual)', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.joshuamcflex;
    ...
    test(flexSpendCardRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.spendingAccountsAnswer(userData, 'medicare-annual');
    ...
    test(fsaRandomQuestion.text, async function () {
        ...
        const expectedAnswer2 = await builder.spendingAccountsAnswer(userData, 'medicare-annual');
