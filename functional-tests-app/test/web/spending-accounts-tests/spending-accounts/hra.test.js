...
suite('Spending Account Tests: HRA', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.hratestmem;
    ...
    test(hsaRandomQuestion.text, async function () {
        ...
        const expectedAnswer2 = await builder.spendingAccountsAnswer(userData, 'hra');
