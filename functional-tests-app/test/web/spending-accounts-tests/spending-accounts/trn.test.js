...
suite('Spending Account Tests: TRN', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.theresaevo;
    ...
    test(trnRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.spendingAccountsAnswer(userData, 'trn');
    ...
    test(hsaRandomQuestion.text, async function () {
        ...
        const expectedAnswer2 = await builder.spendingAccountsAnswer(userData, 'trn');
        ...
        const selectSpendingAccount = await user.conversation.postMessage(action.trn, userData.consumerProfile, this);
