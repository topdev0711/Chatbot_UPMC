...
suite('Spending Account Tests: DCA', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.dcanonmed;
    ...
    test(hsaRandomQuestion.text, async function () {
        ...
        const expectedAnswer2 = await builder.spendingAccountsAnswer(userData, 'dca');
