...
suite('Pharmacy Tests: Commercial plan without Rx', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.maypatr;
    ...
    test(pharmacyRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.pharmacyAnswer(userData, 'other');
