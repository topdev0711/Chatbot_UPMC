...
suite('Pharmacy Tests: CHIP plan with Rx', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.ariller;
    ...
    test(pharmacyRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.pharmacyAnswer(userData, 'pmdc', 'chip');
