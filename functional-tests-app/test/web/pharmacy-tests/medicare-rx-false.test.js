...
suite('Pharmacy Tests: Medicare plan without Rx', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.kichjoh;
    ...
    test(pharmacyRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.pharmacyAnswer(userData, 'pmde');
