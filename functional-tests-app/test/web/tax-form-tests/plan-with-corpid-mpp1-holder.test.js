...
suite('TAX Form Tests: Plan with corpId: MPP1 (Policy holder)', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.tstmyupmc9;
    ...
    test(taxFormRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.taxFormAnswer(userData, 'other');
