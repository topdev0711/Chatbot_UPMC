...
suite('ANOC Tests: Active SNP plan', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.leckjess;
    ...
    test(anocRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.anocAnswer(userData, 'active', 'medicare/snp');
