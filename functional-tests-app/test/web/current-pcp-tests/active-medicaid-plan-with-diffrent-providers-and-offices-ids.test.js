...
suite('PCP Tests: Active Medicaid plan with different providers and offices ids', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.imputedpcp;
    ...
    test(currentPcpRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.currentPcpAnswer(userData, 'active/future', 'different providers', environmentVariables.domain);
