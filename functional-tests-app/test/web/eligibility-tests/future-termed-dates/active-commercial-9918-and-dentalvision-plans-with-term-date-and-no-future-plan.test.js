...
suite('Eligibility Tests: Active Commercial 9918 and DentalVision plans with future term date and no future plan', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.chatbotmissy;
