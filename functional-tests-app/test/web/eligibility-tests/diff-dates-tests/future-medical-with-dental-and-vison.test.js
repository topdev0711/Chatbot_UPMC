...
suite('Eligibility Tests: Future medical coverage with dental and vision coverages with different dates', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.chatbotdejon;
    ...
    test(generalEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.eligibilityAnswer(userData, generalEligibilityRandomQuestion.text, 'future active');
    ...
    test(dentalEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.eligibilityAnswer(userData, dentalEligibilityRandomQuestion.text, 'future active');
    ...
    test(visionEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.eligibilityAnswer(userData, visionEligibilityRandomQuestion.text, 'future active');
    ...
    test(wellnessEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.eligibilityAnswer(userData, wellnessEligibilityRandomQuestion.text, 'future active');
