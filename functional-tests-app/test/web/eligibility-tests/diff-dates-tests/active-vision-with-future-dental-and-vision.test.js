...
suite('Eligibility Tests: Active vision coverage with future dental and vision coverages with different dates', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.chatbotjeffrey;
