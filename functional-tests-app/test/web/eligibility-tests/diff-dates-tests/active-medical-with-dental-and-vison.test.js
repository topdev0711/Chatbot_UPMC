...
suite('Eligibility Tests: Active medical coverage with dental and vision coverages with different dates', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.chatbotcourtney;
