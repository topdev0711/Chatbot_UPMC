...
suite.skip('Hix Status Tests: Active Commercial EXCH plan with Hix Status = A01', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.turkbar; //replace user with stable 888 user "ericao1" after error 400 fix
