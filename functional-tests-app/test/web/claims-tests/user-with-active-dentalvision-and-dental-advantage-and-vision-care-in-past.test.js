...
suite('Claims Tests: user with active DentalVision plan and hasDentalAdvantage: true and hasVisionCare: true in past', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.grudcha;
