...
suite('Claims Tests: user with active DentalVision plan and hasDentalAdvantage: true and hasVisionAdvantage: true in past', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.dvminor04;
