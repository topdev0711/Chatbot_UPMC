...
suite('Claims Tests: user with active DentalVision plan and hasVisionAdvantage: true in past', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.sarmstrong;
    ...
    test(claimsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.claimsAnswer(userData, 'claims');
