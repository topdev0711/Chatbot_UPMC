...
suite('Claims Tests: user with Wellness plan and hasDentalAdvantage: true and hasVisionCare: true in past', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.safkkim;
