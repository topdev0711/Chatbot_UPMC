...
suite('Prompts Tests: Medicare plan Coverage Status -> Medical', function () {
    ...
    test("Coverage Status -> Medical", async function () {
        ...
        validate.buttons(getSecondLevelPrompts.buttons, expectedAnswer.subPromptButtons.coverageStatus); //Skipped becuse of different data in the user profile and Umbraco
        validate.done();
    ...
    test("ID Cards -> Medical", async function () {
        ...
        validate.buttons(getSecondLevelPrompts.buttons, expectedAnswer.subPromptButtons.idCards); //Skipped becuse of different data in the user profile and Umbraco
        validate.done();
