...
suite('Prompts Tests: Pregnancy Support -> Post-pregnancy related concerns', function () {
    ...
    test("Pregnancy Support -> Post-pregnancy related concerns", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.postPregnancyRelatedConcerns, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.postPregnancyRelatedConcerns.text);
