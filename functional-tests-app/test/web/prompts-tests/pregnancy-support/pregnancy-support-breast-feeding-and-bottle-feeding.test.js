...
suite('Prompts Tests: Pregnancy Support -> Breast-feeding and bottle-feeding', function () {
    ...
    test("Pregnancy Support -> Breast-feeding and bottle-feeding", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.breastFeedingAndBottleFeeding, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.breastFeedingAndBottleFeeding.text);
