...
suite('Prompts Tests: Pregnancy Support -> Depression', function () {
    ...
    test("Pregnancy Support -> Depression", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.depression, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.depression.text);
