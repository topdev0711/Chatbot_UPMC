...
suite('Prompts Tests: Pregnancy Support -> Pregnancy-related concerns', function () {
    ...
    test("Pregnancy Support -> Pregnancy-related concerns", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.pregnancyRelatedConcerns, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.pregnancyRelatedConcerns.text);
