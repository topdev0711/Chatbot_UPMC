...
suite('Prompts Tests: Pregnancy Support -> Prenatal classes', function () {
    ...
    test("Pregnancy Support -> Prenatal classes", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.prenatalClasses, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.prenatalClasses.text);
