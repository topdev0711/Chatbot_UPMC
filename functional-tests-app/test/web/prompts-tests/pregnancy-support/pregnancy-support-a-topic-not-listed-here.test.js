...
suite('Prompts Tests: Pregnancy Support -> A topic not listed here', function () {
    ...
    test("Pregnancy Support -> A topic not listed here", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.aTopicNotListedHere, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.aTopicNotListedHere.text);
