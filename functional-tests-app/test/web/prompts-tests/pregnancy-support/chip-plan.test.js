...
suite('Prompts Tests: CHIP plan -> Pregnancy Support is included in menu', function () {
    ...
    test("Pregnancy Support is included in menu", async function () {
        ...
        validate.includes(getFirstMessage.buttons, questions.pregnancySupport.text);
        validate.done();
