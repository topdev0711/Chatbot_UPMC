...
suite('Prompts Tests: Pregnancy Support -> Discomforts of pregnancy', function () {
    ...
    test("Pregnancy Support -> Discomforts of pregnancy", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.discomfortsOfPregnancy, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.discomfortsOfPregnancy.text);
