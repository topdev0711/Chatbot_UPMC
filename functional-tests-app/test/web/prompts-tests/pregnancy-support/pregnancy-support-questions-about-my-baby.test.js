...
suite('Prompts Tests: Pregnancy Support -> Questions about my baby', function () {
    ...
    test("Pregnancy Support -> Questions about my baby", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.questionsAboutMyBaby, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.questionsAboutMyBaby.text);
