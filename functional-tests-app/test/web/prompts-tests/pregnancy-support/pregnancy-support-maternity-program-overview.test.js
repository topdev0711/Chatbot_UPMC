...
suite('Prompts Tests: Pregnancy Support -> Maternity program overview', function () {
    ...
    test("Pregnancy Support -> Maternity program overview", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.maternityProgramOverview, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.maternityProgramOverview.text);
