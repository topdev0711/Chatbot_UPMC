...
suite('Prompts Tests: Pregnancy Support -> Finding a maternity provider', function () {
    ...
    test("Pregnancy Support -> Finding a maternity provider", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.findingAMaternityProvider, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.findingAMaternityProvider.text);
