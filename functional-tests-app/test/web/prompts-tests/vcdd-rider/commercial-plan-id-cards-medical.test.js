...
suite('Prompts Tests: Commercial testnicole plan ID Cards -> Medical', function () {
    ...
    test("ID Cards -> Medical", async function () {
        ...
        const expectedSubAnswer = await builder2.idCardsAnswer(userData, 'active', 'has id card', question.medical.text);
