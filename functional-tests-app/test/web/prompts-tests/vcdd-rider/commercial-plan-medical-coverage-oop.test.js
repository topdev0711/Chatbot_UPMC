...
suite('Prompts Tests: Commercial testnicole plan Medical Coverage -> Out of Pocket', function () {
    ...
    test("Medical Coverage -> Out of Pocket", async function () {
        ...
        const expectedSubAnswer = await builder2.benefitsAnswer(userData, 'outOfPocket', 'active');
