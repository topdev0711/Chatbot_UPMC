...
suite('Prompts Tests: Commercial testnicole plan ID Cards -> Value Added (Dental discount VCDD)', function () {
    ...
    test("ID Cards -> Value Added (Dental discount VCDD)", async function () {
