...
suite('Prompts Tests: Commercial testnicole plan ID Cards -> Assist America Prompts Tests', function () {
    ...
    test("ID Cards -> Assist America", async function () {
        ...
        const expectedSubAnswer = await builder2.idCardsAnswer(userData, 'active', 'has id card', question.assistAmerica.text);
