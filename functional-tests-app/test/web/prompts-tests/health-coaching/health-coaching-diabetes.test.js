...
suite('Prompts Tests: Health Coaching -> Diabetes', function () {
    ...
    test("Health Coaching -> Diabetes", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.diabetes, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.diabetes.text);
