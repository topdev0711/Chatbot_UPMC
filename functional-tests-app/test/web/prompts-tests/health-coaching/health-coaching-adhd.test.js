...
suite('Prompts Tests: Health Coaching -> ADHD', function () {
    ...
    test("Health Coaching -> ADHD", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.adhd, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.adhd.text);
