...
suite('Prompts Tests: Health Coaching -> Stress', function () {
    ...
    test("Health Coaching -> Stress", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.stress, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.stress.text);
