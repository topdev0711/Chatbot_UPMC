...
suite('Prompts Tests: Health Coaching -> Lifestyle Health (General)', function () {
    ...
    test("Health Coaching -> Lifestyle Health (General)", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.lifestyleHealthGeneral, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.lifestyleHealthGeneral.text);
