...
suite('Prompts Tests: Health Coaching -> Weight Management', function () {
    ...
    test("Health Coaching -> Weight Management", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.weightManagement, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.weightManagement.text);
