...
suite('Prompts Tests: Health Coaching -> Pain Management', function () {
    ...
    test("Health Coaching -> Pain Management", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.painManagement, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.painManagement.text);
