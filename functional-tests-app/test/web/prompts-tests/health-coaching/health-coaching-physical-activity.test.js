...
suite('Prompts Tests: Health Coaching -> Physical Activity', function () {
    ...
    test("Health Coaching -> Physical Activity", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.physycalActivity, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.physycalActivity.text);
