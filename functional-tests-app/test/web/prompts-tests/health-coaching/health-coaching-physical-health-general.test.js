...
suite('Prompts Tests: Health Coaching -> Physical Health (General)', function () {
    ...
    test("Health Coaching -> Physical Health (General)", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.physicalHealthGeneral, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.physicalHealthGeneral.text);
