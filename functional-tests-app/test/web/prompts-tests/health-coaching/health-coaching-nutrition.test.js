...
suite('Prompts Tests: Health Coaching -> Nutrition', function () {
    ...
    test("Health Coaching -> Nutrition", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.nutrition, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.nutrition.text);
