...
suite('Prompts Tests: Health Coaching -> Anxiety', function () {
    ...
    test("Health Coaching -> Anxiety", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.anxiety, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.anxiety.text);
