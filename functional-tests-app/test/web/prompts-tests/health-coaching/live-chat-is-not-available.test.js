...
suite('Prompts Tests: Health Coaching -> Live chat is not available', function () {
    ...
    test("Health Coaching -> Call Us", async function () {
    ...
    test("Health Coaching -> Send Message", async function () {
