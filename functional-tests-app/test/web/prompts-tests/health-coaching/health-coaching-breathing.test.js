...
suite('Prompts Tests: Health Coaching -> Breathing', function () {
    ...
    test("Health Coaching -> Breathing", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.breathing, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.breathing.text);
