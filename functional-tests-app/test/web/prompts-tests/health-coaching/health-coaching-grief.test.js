...
suite('Prompts Tests: Health Coaching -> Grief', function () {
    ...
    test("Health Coaching -> Grief", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.grief, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.grief.text);
