...
suite('Prompts Tests: Health Coaching -> Low Back Pain', function () {
    ...
    test("Health Coaching -> Low Back Pain", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.lowBackPain, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.lowBackPain.text);
