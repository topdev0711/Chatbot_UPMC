...
suite('Prompts Tests: Health Coaching -> Behavioral Health (General)', function () {
    ...
    test("Health Coaching -> Behavioral Health (General)", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.behavioralHealthGeneral, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.behavioralHealthGeneral.text);
