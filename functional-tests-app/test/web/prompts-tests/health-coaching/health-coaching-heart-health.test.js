...
suite('Prompts Tests: Health Coaching -> Heart Health', function () {
    ...
    test("Health Coaching -> Heart Health", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.heartHealth, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.heartHealth.text);
