...
suite('Prompts Tests: Health Coaching -> Substance Abuse', function () {
    ...
    test("Health Coaching -> Substance Abuse", async function () {
        ...
        const clickSecondLevelPrompt = await user.conversation.postMessage(liveChat.substanceAbuse, userData.consumerProfile, this);
        ...
        validate.answer(getAnswer.transitionData.selectedSubTopic, liveChat.substanceAbuse.text);
