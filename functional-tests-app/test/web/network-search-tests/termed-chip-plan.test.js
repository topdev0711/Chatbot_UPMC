...
suite('Network Search Tests (Web): user with termed Chip plan', function () {
    ...
    test(networkSearchRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.networkSearchAnswer(userData, 'web', 'termed/future', environmentVariables.domain);
