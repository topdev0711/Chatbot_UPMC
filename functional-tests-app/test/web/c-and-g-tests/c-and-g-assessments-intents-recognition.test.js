...
suite('C&G Assessments Tests: intents recognition', function () {
    ...
    questions.cAndGQuestionsArray.forEach((question) => {
        test(question.text, async function () {
            
            const expectedAnswer = await builder.cAndGAnswer(userData, 'medicare/snp');
