...
suite('Work Partners Tests: intents recognition', function () {
    ...
    questions.compensationQuestionsArray.forEach((question) => {
    ...
    questions.leaveFileQuestionsArray.forEach((question) => {
        test(question.text, async function () {
    ...
    questions.leaveStatusQuestionsArray.forEach((question) => {
        test(question.text, async function () {
