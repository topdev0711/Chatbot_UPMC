...
suite('Live Chat Tests: Transition to Dental support (2 questions)', function () {
    ...
    test(questions.agent.text, async function () {
        ...
        const selectTopic = await user.conversation.postMessage(liveChat.myDentalCoverage, userData.consumerProfile, this);
        ...
        validate.answer(getTopicReponse.transitionData.selectedSubject, liveChat.myDentalCoverage.text);
