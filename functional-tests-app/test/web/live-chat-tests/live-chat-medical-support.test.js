...
suite('Live Chat Tests: Transition to Medical support', function () {
    ...
    test(questions.agent.text, async function () {
        ...
        const selectTopic = await user.conversation.postMessage(liveChat.myMedicalCoverage, userData.consumerProfile, this);
        ...
        validate.answer(getTopicReponse.transitionData.selectedSubject, liveChat.myMedicalCoverage.text);
