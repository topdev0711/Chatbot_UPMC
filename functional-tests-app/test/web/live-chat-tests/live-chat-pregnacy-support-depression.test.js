...
suite('Live Chat Tests: Transition to Pregnancy support -> Depression', function () {
    ...
    test(`${questions.agent.text}, ${questions.escalation.text}, ${questions.iNeedAssistance.text}`, async function () {
        ...
        const selectSubTopic = await user.conversation.postMessage(liveChat.depression, userData.consumerProfile, this);
        ...
        validate.answer(getSubTopicReponse.transitionData.selectedSubTopic, liveChat.depression.text);
