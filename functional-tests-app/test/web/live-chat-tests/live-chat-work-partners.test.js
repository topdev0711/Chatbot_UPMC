...
suite('Live Chat Tests: Transition to WorkPartners', function () {
    ...
    test(questions.agent.text, async function () {
        ...
        const selectTopic = await user.conversation.postMessage(liveChat.workPartners, userData.consumerProfile, this);
        ...
        validate.answer(getTopicReponse.transitionData.selectedSubject, liveChat.workPartners.text);
