...
suite('Live Chat Tests: Transition to Pregnancy support -> Post-pregnancy related concerns', function () {
    ...
    test(`${questions.agent.text}, ${questions.escalation.text}, ${questions.iNeedAssistance.text}`, async function () {
        ...
        const selectSubTopic = await user.conversation.postMessage(liveChat.postPregnancyRelatedConcerns, userData.consumerProfile, this);
        ...
        validate.answer(getSubTopicReponse.transitionData.selectedSubTopic, liveChat.postPregnancyRelatedConcerns.text);
