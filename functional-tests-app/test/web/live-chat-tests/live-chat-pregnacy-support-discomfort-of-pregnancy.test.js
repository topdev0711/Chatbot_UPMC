...
suite('Live Chat Tests: Transition to Pregnancy support -> Discomforts of pregnancy', function () {
    ...
    test(`${questions.agent.text}, ${questions.escalation.text}, ${questions.iNeedAssistance.text}`, async function () {
        ...
        const selectSubTopic = await user.conversation.postMessage(liveChat.discomfortsOfPregnancy, userData.consumerProfile, this);
        ...
        validate.answer(getSubTopicReponse.transitionData.selectedSubTopic, liveChat.discomfortsOfPregnancy.text);
