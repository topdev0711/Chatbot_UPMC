...
suite('Live Chat Tests: Transition to Health coaching -> Lifestyle Health (General)', function () {
    ...
    test(`${questions.agent.text}, ${questions.escalation.text}, ${questions.iNeedAssistance.text}`, async function () {
        ...
        const selectSubTopic = await user.conversation.postMessage(liveChat.lifestyleHealthGeneral, userData.consumerProfile, this);
        ...
        validate.answer(getSubTopicReponse.transitionData.selectedSubTopic, liveChat.lifestyleHealthGeneral.text);
