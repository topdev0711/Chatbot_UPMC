...
suite('Live Chat Tests: Transition to Pregnancy support -> Pregnancy-related concerns', function () {
    ...
    test(`${questions.agent.text}, ${questions.escalation.text}, ${questions.iNeedAssistance.text}`, async function () {
        ...
        const selectSubTopic = await user.conversation.postMessage(liveChat.pregnancyRelatedConcerns, userData.consumerProfile, this);
        ...
        validate.answer(getSubTopicReponse.transitionData.selectedSubTopic, liveChat.pregnancyRelatedConcerns.text);
