...
suite('Live Chat Tests: Transition to Health coaching -> Tobacco Cessation', function () {
    ...
    test(`${questions.agent.text}, ${questions.escalation.text}, ${questions.iNeedAssistance.text}`, async function () {
        ...
        const selectSubTopic = await user.conversation.postMessage(liveChat.tobaccoCessation, userData.consumerProfile, this);
        ...
        validate.answer(getSubTopicReponse.transitionData.selectedSubTopic, liveChat.tobaccoCessation.text);
