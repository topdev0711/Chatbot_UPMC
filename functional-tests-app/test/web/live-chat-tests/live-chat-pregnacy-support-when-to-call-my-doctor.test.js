...
suite('Live Chat Tests: Transition to Pregnancy support -> When to call my doctor', function () {
    ...
    test(`${questions.agent.text}, ${questions.escalation.text}, ${questions.iNeedAssistance.text}`, async function () {
        ...
        const selectSubTopic = await user.conversation.postMessage(liveChat.whenToCallMyDoctor, userData.consumerProfile, this);
        ...
        validate.answer(getSubTopicReponse.transitionData.selectedSubTopic, liveChat.whenToCallMyDoctor.text);
