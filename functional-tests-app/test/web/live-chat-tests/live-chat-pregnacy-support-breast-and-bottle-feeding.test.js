...
suite('Live Chat Tests: Transition to Pregnancy support -> Breast-feeding and bottle-feeding', function () {
    ...
    test(`${questions.agent.text}, ${questions.escalation.text}, ${questions.iNeedAssistance.text}`, async function () {
        ...
        const selectSubTopic = await user.conversation.postMessage(liveChat.breastFeedingAndBottleFeeding, userData.consumerProfile, this);
        ...
        validate.answer(getSubTopicReponse.transitionData.selectedSubject, liveChat.pregnancySupport.text);
        validate.answer(getSubTopicReponse.transitionData.selectedSubTopic, liveChat.breastFeedingAndBottleFeeding.text);
