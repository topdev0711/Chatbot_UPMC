...
suite('Dependent Eligibility Tests: Future individual vision coverage', function () {
    ...
    test(generalDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, generalDependentEligibilityRandomQuestion.text, 'future', 'individual');
    ...
    test(dentalDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, dentalDependentEligibilityRandomQuestion.text, 'future', 'individual');
    ...
    test(visionDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, visionDependentEligibilityRandomQuestion.text, 'future', 'individual');
