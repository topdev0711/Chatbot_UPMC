...
suite('Dependent Eligibility Tests: Value added coverage', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.chatmarcia;
    ...
    test(dentalDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, dentalDependentEligibilityRandomQuestion.text, 'active', 'value added');
    ...
    test(visionDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, visionDependentEligibilityRandomQuestion.text, 'active', 'value added');
        const expectedLiveChatAnswer = await builder2.liveChatAnswer(userData);
