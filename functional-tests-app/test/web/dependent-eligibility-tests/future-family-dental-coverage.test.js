...
suite('Dependent Eligibility Tests: Future family dental coverage', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.chatchuck;
    ...
    test(generalDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, generalDependentEligibilityRandomQuestion.text, 'future', 'family');
    ...
    test(dentalDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, dentalDependentEligibilityRandomQuestion.text, 'future', 'family');
    ...
    test(visionDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, visionDependentEligibilityRandomQuestion.text, 'future', 'family');
