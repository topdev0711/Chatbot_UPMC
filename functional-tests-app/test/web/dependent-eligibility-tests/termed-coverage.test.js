...
suite('Dependent Eligibility Tests: Termed coverage', function () {
    ...
    test(generalDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, generalDependentEligibilityRandomQuestion.text, 'termed');
    ...
    test(dentalDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, dentalDependentEligibilityRandomQuestion.text, 'termed');
    ...
    test(visionDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, visionDependentEligibilityRandomQuestion.text, 'termed');
