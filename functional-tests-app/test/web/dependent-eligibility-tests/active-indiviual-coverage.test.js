...
suite('Dependent Eligibility Tests: Active individual coverage', function () {
    ...
    test(dentalDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, dentalDependentEligibilityRandomQuestion.text, 'active', 'individual');
    ...
    test(visionDependentEligibilityRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.dependentEligibilityAnswer(userData, visionDependentEligibilityRandomQuestion.text, 'active', 'individual');
