...
suite('HIA Submission Assessments Tests: Active Commercial plan + corpId = U249', function () {
    ...
    test(hiaSubmissionFormRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.hiaSubmissionFormAnswer(userData, 'hia pdf form');
