...
suite('MyUPMC Redirects Tests: Termed CHIP plan', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.chipTstapostrophe;
    ...
    test(currentAppointmentRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.myUpmcRedirectsAnswer(userData, 'current appointment', 'chip');
    ...
    test(scheduleAnAppointmentRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.myUpmcRedirectsAnswer(userData, 'schedule an appointment', 'chip');
    ...
    test(testResultsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.myUpmcRedirectsAnswer(userData, 'test results', 'chip');
