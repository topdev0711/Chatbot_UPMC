...
suite('MyUPMC Redirects Tests: intents recognition', function () {
    ...
    questions.currentAppointmentQuestionsArray.forEach((question) => {
    ...
    questions.scheduleAnAppointmentQuestionsArray.forEach((question) => {
        test(question.text, async function () {
    ...
    questions.testResultsQuestionsArray.forEach((question) => {
        test(question.text, async function () {
