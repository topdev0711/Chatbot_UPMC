...
suite('Pref Center Tests: Dependent with on-exchange plan', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.shawleyk123;
    ...
    test(addressUpdateRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.prefCenterAnswer(userData, 'address', 'dependent-on-exchange');
