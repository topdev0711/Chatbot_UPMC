...
suite('Pref Center Tests: Holder with off-exchange plan', function () {
    ...
    test(addressUpdateRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.prefCenterAnswer(userData, 'address', 'holder-off-exchange');
