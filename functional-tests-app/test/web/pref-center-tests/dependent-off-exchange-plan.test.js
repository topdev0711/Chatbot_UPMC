...
suite('Pref Center Tests: Dependent with off-exchange plan', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.bonakev;
    ...
    test(addressUpdateRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.prefCenterAnswer(userData, 'address', 'dependent-off-exchange');
