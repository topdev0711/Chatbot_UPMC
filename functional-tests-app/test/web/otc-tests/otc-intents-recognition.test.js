...
suite('OTC Tests: intents recognition', function () {
    ...
    questions.otcQuestionsArray.forEach((question) => {
        test(question.text, async function () {
            
            const expectedAnswer = await builder.otcAnswer(userData, 'active', 'medicare');
