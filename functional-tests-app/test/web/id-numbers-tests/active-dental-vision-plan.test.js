...
suite('ID Numbers Tests: Active DentalVision plan (Vision)', function () {
    ...
    test(generalIdNumbersRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.idNumbersAnswer(userData, generalIdNumbersRandomQuestion.text, 'active', 'dentalvision');
    ...
    test(visionIdNumbersRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.idNumbersAnswer(userData, visionIdNumbersRandomQuestion.text, 'active', 'dentalvision');
    ...
    test(dentalIdNumbersRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.idNumbersAnswer(userData, dentalIdNumbersRandomQuestion.text, 'active', 'dentalvision');
    ...
    test(visionIdNumbersRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.idNumbersAnswer(userData, visionIdNumbersRandomQuestion.text, 'active', 'dentalvision');
        const expectedIdCardAnswer = await builder2.idCardsAnswer(userData, 'active', 'has id card', visionIdNumbersRandomQuestion.text);
        const postMessage = await user.conversation.postMessage(visionIdNumbersRandomQuestion, userData.consumerProfile, this);
