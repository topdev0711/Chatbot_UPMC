...
suite('ID Numbers Tests: Active Non-medical plan', function () {
    ...
    test(generalIdNumbersRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.idNumbersAnswer(userData, generalIdNumbersRandomQuestion.text, 'active', 'wellness/non-medical');
        ...
        validate.jsonSchema(getAnswer.json, answerSchema.wellnessNonMedicalAnswer);
    ...
    test(visionIdNumbersRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.idNumbersAnswer(userData, visionIdNumbersRandomQuestion.text, 'active', 'wellness/non-medical');
    ...
    test(dentalIdNumbersRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.idNumbersAnswer(userData, dentalIdNumbersRandomQuestion.text, 'active', 'wellness/non-medical');
