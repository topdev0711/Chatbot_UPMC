...
suite('ID Numbers Tests: Active Medicaid plan (Medical)', function () {
    ...
    test(generalIdNumbersRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.idNumbersAnswer(userData, generalIdNumbersRandomQuestion.text, 'active', 'medicaid/chc');
    ...
    test(visionIdNumbersRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.idNumbersAnswer(userData, visionIdNumbersRandomQuestion.text, 'active', 'medicaid/chc');
    ...
    test(dentalIdNumbersRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.idNumbersAnswer(userData, dentalIdNumbersRandomQuestion.text, 'active', 'medicaid/chc');
