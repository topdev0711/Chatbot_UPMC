...
suite('ID Card Tests: User with UPMC HP ID Card', function () {
    ...
    test(generalIdCardRandomQuestion.text, async function () {
        ...
        const expectedIdCardAnswer = await builder.idCardsAnswer(userData, 'active', 'has id card', generalIdCardRandomQuestion.text, idCard.idCardsIds.upmcHealthPlan);
        ...
        const clickIdCardButton = await user.conversation.postMessage(idCard.upmcHealthPlanIdCard, userData.consumerProfile, this);
    ...
    test(upmcHealthPlanIdCardRandomQuestion.text, async function () {
        ...
        const expectedIdCardAnswer = await builder.idCardsAnswer(userData, 'active', 'has id card', upmcHealthPlanIdCardRandomQuestion.text);
