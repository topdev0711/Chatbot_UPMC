...
suite('Benefits Tests: User with spending summary error', function () {
    ...
    test(deductibleRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder2.benefitsAnswer(userData, 'deductible', 'ss error');
        const expectedLiveChatAnswer = await builder3.liveChatAnswer(userData);
    ...
    test(oopRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder2.benefitsAnswer(userData, 'outOfPocket', 'ss error');
        const expectedLiveChatAnswer = await builder3.liveChatAnswer(userData);
