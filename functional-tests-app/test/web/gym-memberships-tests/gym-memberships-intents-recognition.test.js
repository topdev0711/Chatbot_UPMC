...
suite('Gym Membership Tests: intents recognition', function () {
    ...
    questions.gymMembershipsQuestionsArray.forEach((question) => {
        test(question.text, async function () {
            
            const expectedAnswer = await builder.gymMembershipsAnswer(userData, 'active', 'Silver Sneakers');
