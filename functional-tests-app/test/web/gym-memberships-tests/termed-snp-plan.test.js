...
suite('Gym Membership Tests: Termed SNP plan', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.chatmichael;
    ...
    test(gymMembershipsRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.gymMembershipsAnswer(userData, 'termed', 'Silver Sneakers');
