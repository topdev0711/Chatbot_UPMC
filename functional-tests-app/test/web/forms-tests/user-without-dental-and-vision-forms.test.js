...
suite('Assessments Tests: user without dental and vision forms (Active Commercial plan)', function () {

    suiteSetup(async function () {
        userId = environmentVariables.user.chatbotlisa;
    ...
    test(dentalFormRandomQuestion.text, async function () {
        ...
        const expectedAnswer = await builder.formsAnswer(userData, 'dental', 'unavailable');
